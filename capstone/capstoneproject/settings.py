...
# --- Determine if we are in a production (Google Cloud) or local environment ---
# This is a cleaner way to check, using a single variable.
...
if IS_PRODUCTION:
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-for-dev') # Fallback for local
...
if IS_PRODUCTION:
    ...
    APPROVED_USER_EMAILS = [] # Empty list for local dev
